...
HD_PWD='C:/Users/conno/Documents/Stuff/UIUC/2024-2025/FALL/ECE385/final/repo/final_project/final_project.runs/display_buffer_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_buffer_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_buffer_bram.tcl
