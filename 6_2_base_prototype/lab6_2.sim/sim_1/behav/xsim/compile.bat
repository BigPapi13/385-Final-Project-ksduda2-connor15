...
REM
REM Generated by Vivado on Mon Dec 09 11:21:57 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj main_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj main_test_vlog.prj -log xvlog.log
