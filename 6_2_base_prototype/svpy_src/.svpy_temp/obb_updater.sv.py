...
svwrite("    ")
svpy.inline_state = True
svwrite(rotational_impulse.declare("input"))
svpy.inline_state = False
svwrite(",\n")
dump_queue()
svwrite("    ")
...
svwrite("    ///////// TO-DO: MAKE IT SO OMEGA IS UPDATED WITH IMPULSE AS WELL\n")
dump_queue()
svwrite("    ////////  ALSO TO-DO: Apply shift here\n")
dump_queue()
svwrite("end\n")
dump_queue()
end_comb()
...
svwrite("    ////////// TO-DO: UPDATE ROTATION WITH UPDATED VALUE FROM IMPULSE\n")
dump_queue()
