...
obb1.declare()
obb1_ld.declare()
svwrite("    obb_reg #(.X_INIT(10), .Y_INIT(32), .X_VEL_INIT(0.3), .Y_VEL_INIT(-0.1), .ANGLE_INIT(0.7), .MASS_INIT(4), .OMEGA_INIT(0)) obb1(\n")
dump_queue()
svwrite("        ")
...
obb2.declare()
obb2_ld.declare()
svwrite("    obb_reg #(.X_INIT(45), .Y_INIT(32), .X_VEL_INIT(-0.2), .Y_VEL_INIT(0.5), .WIDTH_INIT(15), .HEIGHT_INIT(5), .MASS_INIT(4), .OMEGA_INIT(0)) obb2(\n")
dump_queue()
svwrite("        ")
svpy.inline_state = True
...
svwrite("        ")
svpy.inline_state = True
svwrite(impulse1.module_assign(impulse1))
svpy.inline_state = False
svwrite(",\n")
dump_queue()
svwrite("        ")
svpy.inline_state = True
svwrite(impulse2.module_assign(impulse2))
svpy.inline_state = False
svwrite(",\n")
dump_queue()
svwrite("        .ignore_impulse(ignore_impulse)\n")
dump_queue()
svwrite("    );\n")
dump_queue()
svwrite("\n")
...
dump_queue()
svwrite("        .impulse_en(is_collision & ~ignore_impulse),\n")
dump_queue()
svwrite("        .update_en(1'b1),\n")
dump_queue()
svwrite("        ")
svpy.inline_state = True
svwrite(Impulse.module_assign(impulse1))
svpy.inline_state = False
svwrite(",\n")
dump_queue()
svwrite("        ")
...
svwrite("        ")
svpy.inline_state = True
svwrite(Impulse.module_assign(impulse2))
svpy.inline_state = False
svwrite(",\n")
dump_queue()
svwrite("        ")
