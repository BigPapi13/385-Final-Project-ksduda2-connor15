import svpy
from svpy import *
svpy.writefile = open("../lab6_2_provided/design_source/collision_detector_backup2.sv", 'w')
import svmath
import utils
from svmath import *
...
svwrite("\n")
dump_queue()
svwrite("logic signed [31:0] pen_min_uA;\n")
dump_queue()
svwrite("logic signed [31:0] pen_max_uA;\n")
dump_queue()
svwrite("logic signed [31:0] pen_min_vA;\n")
dump_queue()
svwrite("logic signed [31:0] pen_max_vA;\n")
dump_queue()
svwrite("\n")
dump_queue()
...
svwrite("\n")
dump_queue()
svwrite("// If the penetration is negative, then there's separation\n")
dump_queue()
svwrite("assign separate_min_uA = pen_min_uA[31];\n")
dump_queue()
svwrite("assign separate_max_uA = pen_max_uA[31];\n")
dump_queue()
svwrite("assign separate_min_vA = pen_min_vA[31];\n")
dump_queue()
svwrite("assign separate_max_vA = pen_max_vA[31];\n")
dump_queue()
svwrite("\n")
dump_queue()
...
svwrite("\n")
dump_queue()
svwrite("logic signed [31:0] pen_min_uB;\n")
dump_queue()
svwrite("logic signed [31:0] pen_max_uB;\n")
dump_queue()
svwrite("logic signed [31:0] pen_min_vB;\n")
dump_queue()
svwrite("logic signed [31:0] pen_max_vB;\n")
dump_queue()
svwrite("\n")
dump_queue()
svwrite("always_comb begin\n")
...
svwrite("// If the penetration is negative, then there's separation\n")
dump_queue()
svwrite("assign separate_min_uB = pen_min_uB[31];\n")
dump_queue()
svwrite("assign separate_max_uB = pen_max_uB[31];\n")
dump_queue()
svwrite("assign separate_min_vB = pen_min_vB[31];\n")
dump_queue()
svwrite("assign separate_max_vB = pen_max_vB[31];\n")
dump_queue()
svwrite("\n")
dump_queue()
...
dump_queue()
svwrite("logic signed [31:0] min_pen_uA;\n")
dump_queue()
svwrite("logic signed [31:0] min_pen_vA;\n")
dump_queue()
svwrite("logic signed [31:0] min_pen_uB;\n")
dump_queue()
svwrite("logic signed [31:0] min_pen_vB;\n")
dump_queue()
svwrite("\n")
dump_queue()
svwrite("logic signed [31:0] min_pen_u;\n")
dump_queue()
svwrite("logic signed [31:0] min_pen_v;\n")
dump_queue()
svwrite("\n")
dump_queue()
svwrite("logic signed [31:0] min_pen;\n")
dump_queue()
svwrite("\n")
dump_queue()
svwrite("// Normal value intermediaries\n")
dump_queue()
...
svwrite("\n")
dump_queue()
svwrite("// If any penetrations is negative, there is no collision\n")
dump_queue()
svwrite("assign is_collision = ~min_pen[31];\n")
dump_queue()
svwrite("endmodule")
dump_queue()
